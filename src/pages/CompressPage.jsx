        ...
        <div className="container mx-auto px-6 py-20 relative min-h-[80vh]">
            ...
            <div className="text-center max-w-3xl mx-auto mb-16 relative z-10">
                <h1 className="text-5xl md:text-6xl font-[900] tracking-tight mb-6 leading-tight uppercase">
                    Compress <span className="hero-gradient">PDF</span>
                </h1>
                <p className="text-xl text-[#64748B] font-medium leading-relaxed">
                    Reduce the file size of your PDF while optimizing for maximal quality. Perfect for sharing and storage.
                </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                {!downloadUrl ? (
                    ...
                    <div className="max-w-xl mx-auto glass p-12 rounded-[3rem] shadow-2xl text-center border-white/50 animate-fade-up">
                        ...
                        <h2 className="text-4xl font-black mb-4 text-secondary">Optimized!</h2>
                        <p className="text-[#64748B] text-lg font-medium mb-12 italic">"Your PDF is now smaller and ready to fly."</p>
